...
//! ================== Read All Catagory ===================
export const read_all_Cataroy__Request__API = async () => {
  let URL = "/api/dashboard/product/catagory";
...
//! ================== Read All Service ===================
export const read_all_aproved__Request__API = async () => {
  let URL = "/api/dashboard/product/aprovalcontent";
  console.log(URL);
  try {
    const result = await axios.get(URL);
...
//! ================== Delete Single Service ===================
export const aproval_service__Request__API = async (id) => {
  let URL = `/api/dashboard/product/aproval?id=${id}`;
  try {
